...
<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
	...
	<div class="d-flex align-items-center">
		...
		@can('create', App\Models\Investment::class)
			<a href="{{ route('investments.create') }}" class="btn btn-light-primary btn-sm mr-1">@include('svg.investment', ['class' => 'navi-icon']) Dodaj Ubezpieczenie</a>
		@endcan
		...
		@can('viewAny', App\Models\Trash::class)
			<a href="{{ route('trash.index', ['model' => 'investments']) }}" class="btn btn-light-danger btn-sm">@include('svg.trash', ['class' => 'navi-icon']) Elementy usunięte</a>
		@endcan
	</div>
</div>
@stop
