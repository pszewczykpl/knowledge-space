...
<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
	...
	<div class="d-flex align-items-center">
        ...
        <input type="submit" class="btn btn-light-primary btn-icon-sm ml-1" form="investment_store_form" value="Zapisz">
            ...
            <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x" role="tablist">
                <li class="nav-item mr-3">
                    <a class="nav-link active" data-toggle="tab" href="#info" role="tab">
                        ...
                        <span class="nav-text font-weight-bold">Informacje ogólne</span>
                    </a>
                </li>
                <li class="nav-item mr-3">
                    <a class="nav-link" data-toggle="tab" href="#files" role="tab">
                        ...
                        <span class="nav-text font-weight-bold">Komplet dokumentów</span>
                    </a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 my-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid" type="text" value="" name="name" id="name" placeholder="Wprowadź nazwę produktu">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid" type="text" value="" name="code" id="code" placeholder="Wprowadź kod produktu">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid" type="text" value="" name="code_owu" id="code_owu" placeholder="Wprowadź kod OWU">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid" type="text" value="" name="code_toil" id="code_toil" placeholder="Wprowadź kod TOiL">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid" type="text" value="" name="group" id="group" placeholder="Wprowadź grupę produktową">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <select class="form-control form-control-lg form-control-solid" value="" name="type" id="type" placeholder="Wprowadź typ produktu">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid" type="text" value="" name="dist" id="dist" placeholder="Wprowadź nazwę dystrybutora">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid" type="text" value="" name="dist_short" id="dist_short" placeholder="Wprowadź kod dystrybutora">
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 my-2">
                            ...
                            <div class="row">
								<label class="col-3"></label>
								<div class="col-9">
									<h6 class="text-dark font-weight-bold mb-10">Dane kompletu dokumentów:</h6>
								</div>
							</div>
                            
                            <div class="form-group row">
                                <label class="col-form-label col-3 text-lg-right text-left">Data początku obowiązywania</label>
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid datepicker" style="width: 100% !important;" type="text" value="" name="edit_date" id="edit_date" readonly placeholder="Wprowadź datę początku obowiązywania">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <select class="form-control form-control-lg form-control-solid" value="" name="status" id="status" placeholder="Wprowadź status">
...
<script src="{{ asset('js/pages/products/investments/create.js') }}" type="text/javascript"></script>
@stop