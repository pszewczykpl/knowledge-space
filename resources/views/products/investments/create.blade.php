...
@section('toolbar')
        <a href="{{ route('investments.index') }}" class="btn btn-clean btn-sm">@include('svg.back', ['class' => 'navi-icon']) Anuluj</a>
        @can('create', App\Models\Investment::class)
            <a onclick='document.getElementById("investment_store_form").submit();' class="btn btn-light-primary btn-sm ml-1">@include('svg.save', ['class' => 'navi-icon']) Zapisz</a>
        @endcan
@stop
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input class="form-control form-control-lg form-control-solid" type="text" name="code_toil" id="code_toil" placeholder="Wpisz Kod TOiL">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-3 text-lg-right text-left">Grupa produktowa:</label>
                            <div class="col-9">
                                <input class="form-control form-control-lg form-control-solid" type="text" name="group" id="group" placeholder="Wpisz Grupę produktową">
                            </div>
                        </div>
                        <div class="form-group row">
