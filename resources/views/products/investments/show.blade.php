...
<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
	...
	<div class="d-flex align-items-center">
        ...
        <a onclick="ShareInvestments('{{ $investment->id }}')" class="btn btn-light-primary btn-icon-sm ml-1">
            <i class="la la-share-alt"></i>Udostępnij
        </a>

		@auth
			<a href="{{ route('investments.edit', $investment->id) }}" class="btn btn-light-primary btn-icon-sm ml-1">
		...
		@if($investment->status == 'N')
			<div class="card card-custom gutter-b">
				...
				<div class="card-body pt-2">
					<p class="text-dark-50"><span class="font-weight-bold">Pamiętaj!</span> Dla wybranego kodu TOiL istnieje nowszy komplet dokumentów.</p>
				</div>
			</div>
		@else
			<div class="card card-custom gutter-b">
				...
				<div class="card-body pt-2">
					<p class="text-dark-50">To najnowszy komplet dokumentów dla wybranego kodu TOiL.</p>
				</div>
			</div>
		@endif
		...
		<div class="card card-custom gutter-b"">
			...
			<div class="card-body py-0 pt-4">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $investment->name }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-sm-0">
				<div class="form-group row my-sm-0">
					<label class="col-6 col-form-label text-right">Kod produktu:</label>
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $investment->code }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-sm-0">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $investment->code_owu }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-sm-0">
				<div class="form-group row my-sm-0">
					<label class="col-6 col-form-label text-right">Kod TOiL:</label>
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $investment->code_toil }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-sm-0">
				<div class="form-group row my-sm-0">
					<label class="col-6 col-form-label text-right">Grupa produktowa:</label>
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $investment->group }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-sm-0">
				<div class="form-group row my-sm-0">
					<label class="col-6 col-form-label text-right">Dystrybutor:</label>
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $investment->dist }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-sm-0">
				<div class="form-group row my-sm-0">
					<label class="col-6 col-form-label text-right">Kod dystrybutora:</label>
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $investment->dist_short }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-0 pb-4">
				<div class="form-group row my-sm-0">
					<label class="col-6 col-form-label text-right">Typ produktu:</label>
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $investment->type }}</span>
					</div>
				</div>
			</div>
		</div>
        ...
        <div class="card card-custom">
			...
			<div class="card-body py-0 pt-4">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $investment->updated_at }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-sm-0">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $investment->created_at }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-0 pb-4">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $investment->user->username }}</span>
					</div>
				</div>
			</div>
		</div>
            ...
            <div class="card-body px-0">
                <div class="tab-content pt-2">
					...
					@auth
						{!! Form::open(['route' => 'notes.store', 'method' => 'post']) !!}
							...
							<div class="form-group">
								<input type="hidden" id="investment_id" name="investment_id" value="{{ $investment->id }}">
                    ...
                    <div class="tab-pane active" id="files" role="tabpanel">
                        ...
                        <x-panels.files-panel :files="$investment->files" />
