				...
				<div class="card-body px-0">
					<div class="tab-content pt-2">
						<div class="tab-pane " id="notes" role="tabpanel">
							<x-panels.notes :notes="$investment->get_cached_relation('notes')" -type="investment" :id="$investment->id"  />
						</div>
						<div class="tab-pane active" id="files" role="tabpanel">
							<x-panels.files :files="$investment->get_cached_relation('files')" :name="$investment->extended_name()" -type="investment" :id="$investment->id" />
						</div>
