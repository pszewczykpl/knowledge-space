...
{{--		<button type="button" class="btn btn-clean btn-sm mr-3" id="search_box_panel_button">Zaawansowane</button>--}}
		<div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-3 ml-2 bg-gray-200"></div>
	...
	<div class="d-flex align-items-center">
		...
		@can('create', App\Models\Employee::class)
			<a href="{{ route('employees.create') }}" class="btn btn-light-primary btn-sm mr-1">@include('svg.employee', ['class' => 'navi-icon']) Dodaj Ubezpieczenie</a>
		@endcan
		...
		@can('viewAny', App\Models\Trash::class)
			<a href="{{ route('trash.index', ['model' => 'employees']) }}" class="btn btn-light-danger btn-sm">@include('svg.trash', ['class' => 'navi-icon']) Elementy usunięte</a>
		@endcan
	</div>
</div>
@stop
