					...
					<div class="mb-1">
						<div class="alert alert-custom alert-light-primary fade show mb-5" role="alert">
							...
							<div class="alert-text">
								Poniżej przedstawiono wszystkie dostępne komplety dokumentów dla produktów pracowniczych.
							</div>
								...
								<div class="row align-items-center">
									...
									<div class="col-md-3 pb-3 my-2 my-md-0">
										<div class="input-icon" id="filter_col2" data-column="2">
											<input type="text" class="form-control form-control-solid column_filter" placeholder="Dokumenty ważne od" id="col2_filter" />
											<span>
												<i class="flaticon2-search-1 text-muted"></i>
											</span>
										</div>
