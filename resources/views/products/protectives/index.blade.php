...
@section('content')
	<x-layout.datatable id="protectives_datatable" :columns='["Nazwa produktu", "Kod dystrybutora", "Kod produktu", "Kod OWU", "Ostatnia aktualizacja", "Akcje"]'>
		<x-slot name="search">
			...
			<div class="col-md-3 pb-3 my-2 my-md-0">
				...
				<div class="form-check form-switch form-check-custom form-check-solid mt-1">
					<input class="form-check-input" type="checkbox" id="active_or_all_protectives" />
					<label class="form-check-label" for="active_or_all_protectives" id="active_or_all_title">Pokaż dane archiwalne</label>
				</div>
			</div>
		</x-slot>
	</x-layout.datatable>
