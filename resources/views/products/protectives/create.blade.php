...
<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
	...
	<div class="d-flex align-items-center">
        ...
        <input type="submit" class="btn btn-light-primary btn-icon-sm ml-1" form="protective_store_form" value="Zapisz">
...
<div class="container">
    ...
    <div class="card-body px-0">
        {!! Form::open(['route' => 'protectives.store', 'method' => 'post', 'files' => true, 'id' => 'protective_store_form']) !!}
            {!! Form::token() !!}
            <div class="tab-content pt-5">
                <div class="tab-pane active" id="info" role="tabpanel">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <input class="form-control form-control-lg form-control-solid" type="text" value="" name="code_owu" id="code_owu" placeholder="Wprowadź kod (Ogólnych) Warunków Ubezpieczenia">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <input class="form-control form-control-lg form-control-solid" type="text" value="" name="subscription" id="subscription" placeholder="Wprowadź numer subskrypcji">
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="files" role="tabpanel">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <input class="form-control form-control-lg form-control-solid datepicker" type="text" value="" name="edit_date" id="edit_date" readonly placeholder="Wprowadź datę początku obowiązywania kompletu">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 text-right col-form-label">Status kompletu dokumentów</label>
                        <div class="col-lg-9 col-xl-6">
                            <select class="form-control form-control-lg form-control-solid selectpicker" name="status" id="status">
...
<script src="{{ asset('js/pages/products/protectives/create.js') }}" type="text/javascript"></script>
@stop