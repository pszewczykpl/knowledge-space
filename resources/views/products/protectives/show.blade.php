		...
		<div class="card card-custom gutter-b"">
			<div class="card-header h-auto py-sm-0">
				<div class="card-title">
					...
					<span class="d-block text-muted pt-2 font-size-sm">Dane produktu ochronnego</span></h3>
				</div>
			</div>
        ...
        <div class="card card-custom">
            ...
            <div class="card-body py-0 pb-4">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $protective->user->first_name }} {{ $protective->user->last_name }}</span>
					</div>
				</div>
			</div>
		</div>
