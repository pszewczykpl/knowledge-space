...
<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
	...
	<div class="d-flex align-items-center">
        ...
        <a onclick="ShareProtectives('{{ $protective->id }}')" class="btn btn-light-primary btn-icon-sm ml-1">
            <i class="la la-share-alt"></i>Udostępnij
        </a>

		@auth
			<a href="{{ route('protectives.edit', $protective->id) }}" class="btn btn-light-primary btn-icon-sm ml-1">
				<i class="la la-edit"></i>Edytuj
			</a>

			{{ Form::open([ 'method'  => 'delete', 'route' => [ 'protectives.destroy', $protective->id ] ]) }}
		...
		@if($protective->status == 'N')
			<div class="card card-custom gutter-b">
				...
				<div class="card-body pt-2">
					<p class="text-dark-50"><span class="font-weight-bold">Pamiętaj!</span> Dla wybranego kodu produktu istnieje nowszy komplet dokumentów.</p>
				</div>
			</div>
		@else
			<div class="card card-custom gutter-b">
				...
				<div class="card-body pt-2">
					<p class="text-dark-50">To najnowszy komplet dokumentów dla wybranego kodu produktu.</p>
				</div>
			</div>
		@endif
		...
		<div class="card card-custom">
			...
			<div class="card-body py-0 pt-4">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $protective->name }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-sm-0">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $protective->code }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-sm-0">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $protective->code_owu }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-sm-0">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $protective->dist }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-0">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $protective->dist_short }}</span>
					</div>
				</div>
			</div>
			<div class="card-body py-0 pb-4">
				<div class="form-group row my-sm-0">
					<label class="col-6 col-form-label text-right">Numer subskrypcji:</label>
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $protective->subscription }}</span>
					</div>
				</div>
			</div>
		</div>
        ...
        <div class="card card-custom mt-5">
			...
			<div class="card-body py-0 pt-4">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $protective->updated_at }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-sm-0">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $protective->created_at }}</span>
					</div>
				</div>
			</div>
            <div class="card-body py-0 pb-4">
				<div class="form-group row my-sm-0">
					...
					<div class="col-6">
						<span class="form-control-plaintext font-weight-bolder">{{ $protective->user->username }}</span>
					</div>
				</div>
			</div>
		</div>
                ...
                <div class="tab-content pt-2">
					...
					@auth
						{!! Form::open(['route' => 'notes.store', 'method' => 'post']) !!}
							...
							<div class="form-group">
								...
								<input type="hidden" id="type" name="type" value="protective">
								<input type="hidden" id="protective_id" name="protective_id" value="{{ $protective->id }}">
					...
					<div class="timeline timeline-3">
						<div class="timeline-items">
							@foreach($protective->notes as $note)
                    ...
                    <div class="tab-pane active" id="files" role="tabpanel">
                        ...
                        <x-panels.files-panel :files="$protective->files" />
