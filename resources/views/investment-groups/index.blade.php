...
<div class="row">
	...
	<div class="alert alert-light alert-elevate fade show col-12" role="alert">
		...
		<div class="alert-text">
		    Poniżej przedstawiono wszystkie grupy produktowe dla produktów Inwestycyjnch.
		</div>
			...
			<div class="kt-portlet__body">
				<form class="form">
					<div class="row">
						...
						<x-advanced-search-box placeholder="Opis" column="3" />
						<x-advanced-search-box placeholder="Początek sprzedaży" column="4" />
					</div>
				</form>
				...
				api: "/api/datatables/investment-groups",
				order: [1, "asc"]
			};
				</script>
			</div>
