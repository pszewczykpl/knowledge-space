...
@section('toolbar')
		<a href="{{ route('departments.index') }}" class="btn btn-clean btn-sm mr-1">@include('svg.back', ['class' => 'navi-icon']) {{ __('Cancel') }}</a>
        @can('create', App\Models\Department::class)
        <a onclick='document.getElementById("department_store_form").submit();' class="btn btn-light-primary btn-sm">@include('svg.save', ['class' => 'navi-icon']) {{ __('Save') }}</a>
        @endcan
@stop
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <textarea class="form-control form-control-lg form-control-solid" rows="4" name="description" id="description" placeholder="Opisz krótko departament :-)"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
