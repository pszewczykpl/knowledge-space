...
<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
	...
	<div class="d-flex align-items-center">
		...
		@can('create', App\Models\FileCategory::class)
			<a href="{{ route('file-categories.create') }}" class="btn btn-light-primary btn-sm mr-1">@include('svg.file-category', ['class' => 'navi-icon']) Dodaj Kategorię
			</a>
		@endcan
		@can('viewAny', App\Models\Trash::class)
			<a href="{{ route('trash.index', ['model' => 'file-categories']) }}" class="btn btn-light-danger btn-sm">@include('svg.trash', ['class' => 'navi-icon']) Elementy usunięte</a>
		@endcan
	</div>
</div>
@stop
