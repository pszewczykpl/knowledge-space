...
@section('toolbar')
        <a href="{{ route('file-categories.index') }}" class="btn btn-clean btn-sm mr-1">@include('svg.back', ['class' => 'navi-icon']) {{ __('Cancel') }}</a>
        @can('create', App\Models\FileCategory::class)
        <a onclick='document.getElementById("file_cateogry_store_form").submit();' class="btn btn-light-primary btn-sm">@include('svg.save', ['class' => 'navi-icon']) {{ __('Save') }}</a>
        @endcan
@stop
...
<div class="container">
    ...
    <div class="card card-custom gutter-bs">
        ...
        {!! Form::open(['route' => 'file-categories.store', 'method' => 'post', 'id' => 'file_cateogry_store_form']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input class="form-control form-control-lg form-control-solid" type="text" name="prefix" id="prefix" placeholder="Wpisz Prefix">
                            </div>
                        </div>
                    </div>
                </div>
