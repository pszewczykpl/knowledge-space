			...
			<div class="d-flex w-100 flex-center p-15">
				<div class="login-wrapper">
                    ...
                    <div class="text-dark-75">
						...
						<!-- Bez możliwości rejestracji (tymczasowo) -->
						{{-- <p class="mb-10 text-muted font-weight-bold">Jeśli nie posiadasz konta w serwisie Baza Wiedzy - <a href="{{ route('home.index') }}">Wejdź bez logowania</a>.</p> --}}
						{{-- <a href="{{ route('home.index') }}" class="btn btn-outline-primary btn-pill py-4 px-9 font-weight-bold">Wejdź bez logowania</a> --}}
						
						<!-- Z możliwością rejestracji -->
