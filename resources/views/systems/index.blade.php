			...
			<div class="card card-custom">
				<div class="card-header flex-wrap border-0 pt-6 pb-0">
					<h3 class="card-title align-items-start flex-column">
						...
						<span class="text-muted mt-1 font-weight-bold font-size-sm">Przeglądaj systemy Towarzystwa Ubezpieczeń</span>
					</h3>
					<div class="card-toolbar">
						@can('create', App\Models\System::class)
						<a href="{{ route('systems.create') }}" class="btn btn-light-primary btn-shadow font-weight-bold mr-2">
						...
						@can('viewAny', App\Models\Trash::class)
							<a href="{{ route('trash.index', ['model' => 'systems']) }}" class="btn btn-light-danger btn-shadow font-weight-bold ml-2">
								<span class="svg-icon navi-icon">
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											<rect x="0" y="0" width="24" height="24"/>
