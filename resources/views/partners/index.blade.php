...
<div class="row">
	...
	<div class="alert alert-light alert-elevate fade show col-12" role="alert">
		...
		<div class="alert-text">
		    Poniżej przedstawiono wszystkich partnetów Open Life TU Życie S.A.
		</div>
	...
	<div class="kt-portlet kt-portlet--mobile">
		<div class="kt-section__content">
			<div class="kt-portlet__body">
				<form class="form">
					<div class="row">
						<x-advanced-search-box placeholder="Nazwa" column="0" />
						<x-advanced-search-box placeholder="Symbol" column="1" />
						<x-advanced-search-box placeholder="Typ" column="2" />
						<x-advanced-search-box placeholder="Numer RAU" column="3" />
						<x-advanced-search-box placeholder="NIP" column="4" />
						<x-advanced-search-box placeholder="REGON" column="5" />
					</div>
				</form>
				...
				api: "/api/datatables/distributors",
				order: [1, "asc"]
			};
				</script>
			</div>
