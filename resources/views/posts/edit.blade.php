...
@section('content')
	<x-pages.form>
		{!! Form::open(['route' => ['posts.update', $post->id], 'method' => 'PUT', 'files' => true, 'id' => 'kt_forms_widget_1_form', 'class' => 'ql-quil ql-quil-plain pb-3']) !!}
		{!! Form::token() !!}
										...
										<div class="ps-lg-6">
											<div class="form-group row">
												<div class="col-lg-12">
													...
													<div class="fv-row fv-plugins-icon-container">
														<input type="text" id="title" name="title" class="form-control form-control-lg form-control-solid" placeholder="Wprowadź tytuł" value="{{ $post->title }}">
											...
											<div class="mt-5">
												<div class="show-post fw-normal fs-5 mt-4 text-dark" style="font-family: Poppins, Helvetica, sans-serif;">
													<div id="kt_forms_widget_1_editor" class="py-6 fw-normal fs-5 mt-4 text-dark" style="font-family: Poppins, Helvetica, sans-serif;">{!! $post->content !!}</div>
