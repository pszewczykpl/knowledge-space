			...
			<div class="card card-custom">
				<div class="card-header flex-wrap border-0 pt-6 pb-0">
					...
					<h3 class="card-title align-items-start flex-column">
						...
						<span class="text-muted mt-1 font-weight-bold font-size-sm">Przeglądaj wszystkie komentarze</span>
					</h3>
					@auth
									...
									<ul class="navi navi-hover py-5">
										...
										<li class="navi-item">
											<a href="{{ route('notes.create') }}" class="navi-link">
												<span class="svg-icon navi-icon mr-3">
												...
												<span class="navi-text">Komentarz</span>
											</a>
										</li>
