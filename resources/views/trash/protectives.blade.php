    ...
    <div class="row">
        ...
        <div class="col-12 col-md-8">
            <div class="card card-custom gutter-b">
				<div class="card-body">
					<table class="table table-separate table-head-custom collapsed" id="protectives_trash_datatable">
						<thead>
							<tr>
...
@push('scripts')
 <script src="{{ asset('js_' . str_replace('.', '_', config('app.version')) . '/pages/trash/protectives.js') }}" type="text/javascript"></script>
@endpush