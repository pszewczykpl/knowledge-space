	...
	<div class="offcanvas-content pr-5 mr-n5">
		<div class="d-flex mt-5">
			<div class="symbol symbol-100 mr-5">
				<div class="symbol-label" style="background-image:url('{{ asset('storage/uploads/avatars/') }}/{{ Auth::user()->avatar_filename }}')"></div>
				<i class="symbol-badge bg-success"></i>
			</div>
			<div class="d-flex flex-column">
				<span class="font-weight-bold font-size-h5 text-dark-75">{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</span>
				<div class="navi mt-2">
					<span class="navi-item">
						<span class="navi-link p-0 pb-2">
							...
							<span class="navi-text text-muted text-primary pt-1">{{ Auth::user()->department }}</span>
							@endif
						</span>
					</span>
		...
		<div class="navi navi-spacer-x-0 p-0">
			...
			<a href="#" class="navi-item">
				<div class="navi-link">
					...
					<div class="navi-text">
						<div class="font-weight-bold">Moje aktywności</div>
						<div class="text-muted">Logi działań w aplikacji</div>
					</div>
				</div>
			</a>
