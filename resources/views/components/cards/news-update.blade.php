	...
	<div class="card-body">
		<div class="d-flex align-items-center">
			...
			<div class="d-flex flex-column flex-grow-1">
                <a href="{{ route('users.show', $news->getCachedRelation('user')->id) }}" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">{{ $news->getCachedRelation('user')->fullname() }}</a>
                <div class="d-flex">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="text-muted font-weight-bold">{{ $news->getCachedRelation('user')->getCachedRelation('department')->name }}</span>
                    </div>
                </div>
            </div>
		</div>
