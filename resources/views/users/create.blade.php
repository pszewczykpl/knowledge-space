...
@section('toolbar')
        <a href="{{ route('users.index') }}" class="btn btn-clean btn-sm">@include('svg.back', ['class' => 'navi-icon']) Anuluj</a>
        @can('create', App\Models\User::class)
        <a onclick='document.getElementById("user_store_form").submit();' class="btn btn-light-primary btn-sm ml-1">@include('svg.save', ['class' => 'navi-icon']) Zapisz</a>
        @endcan
@stop
                            ...
                            <div class="form-group row">
								...
								<div class="col-lg-9 col-xl-9">
									<div class="image-input image-input-outline image-input-circle" id="kt_user_avatar">
										<div class="image-input-wrapper" style="background-image: url({{ asset('media/avatars/default.jpg') }})"></div>
