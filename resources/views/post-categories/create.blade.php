...
@section('toolbar')
        <a href="{{ route('post-categories.index') }}" class="btn btn-clean btn-sm mr-1">@include('svg.back', ['class' => 'navi-icon']) Anuluj</a>
        @can('create', App\Models\PostCategory::class)
        <a onclick='document.getElementById("post_cateogry_store_form").submit();' class="btn btn-light-primary btn-sm">@include('svg.save', ['class' => 'navi-icon']) Zapisz</a>
        @endcan
@stop
                    ...
                    <li class="nav-item mr-3">
                        <a class="nav-link active" data-toggle="tab" href="#info" role="tab">
                            <span class="nav-icon mr-2">
                                @include('svg.post-category', ['class' => 'mr-3'])
                            </span>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <textarea class="form-control form-control-lg form-control-solid" type="text" name="description" id="description" placeholder="Wpisz Opis"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
